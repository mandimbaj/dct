...
class IncomeGroup extends Model
{
    ...
    protected $table = 'stg_worldbank_incomegroups';

    protected $primaryKey = 'wb_income_groupid';
    ...
    {
        return $this->hasMany(IncomeGroupTranslation::class, 'master_id', 'wb_income_groupid');
    }
