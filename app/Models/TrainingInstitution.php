...
class TrainingInstitution extends Model
{
    ...
    {
        static::creating(function (TrainingInstitution $institution): void {
            GeneratedCode::ensureUuid($institution);
            GeneratedCode::ensure($institution, 'code', 'INST', 15);
            $institution->user_id ??= auth()->id() ?? 1;
        });
    }
