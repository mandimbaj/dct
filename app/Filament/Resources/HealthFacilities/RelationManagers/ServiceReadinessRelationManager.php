...
class ServiceReadinessRelationManager extends RelationManager
{
    use ConfiguresFacilityServiceOptions;

    protected static string $relationship = 'serviceReadiness';
        ...
        return $schema
            ->components([
                Select::make('domain_id')
                    ...
                    ->options(fn (): array => self::domainOptions(3, 'Level 1'))
                    ->getSearchResultsUsing(fn (?string $search): array => self::domainOptions(3, 'Level 1', $search))
                    ->live()
                    ->searchable()
                    ->required(),
                ...
                TextInput::make('available')
                    ...
                    ->minValue(0)
                    ->required(),
                TextInput::make('require')
                    ->label(__('aho.fields.required'))
                    ->numeric()
                    ->minValue(0)
                    ->required(),
