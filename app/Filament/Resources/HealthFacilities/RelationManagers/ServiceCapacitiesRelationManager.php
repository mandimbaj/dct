        ...
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('uploadedBy.name')
                    ...
                    ->state(fn (FacilityServiceCapacity $record): string => UserDisplayName::uploadedBy(
                        $record->uploadedBy,
                        $record->warehouseUploadedBy,
                        $record->user_id,
                    ))
                    ->tooltip(fn (FacilityServiceCapacity $record): ?string => UserDisplayName::uploadedByTooltip(
                        $record->uploadedBy,
                        $record->warehouseUploadedBy,
                        $record->user_id,
                    ))
